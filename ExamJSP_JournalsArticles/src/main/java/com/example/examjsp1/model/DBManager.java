package com.example.examjsp1.model;
...
public class DBManager {
    ...
    private int getNextJournal() {
        try {
            String sql = "SELECT MAX(id) as max_id FROM journals";
    ...
    private int getNextArticleId() {
        try {
            String sql = "SELECT MAX(id) as max_id FROM articles";
